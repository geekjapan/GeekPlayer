...
void main() {
  group('PagePosition', () {
    ...
    test('structural equality and hashCode', () {
      final PagePosition a =
          PagePosition(pageIndex: 3, scrollFraction: 0.5);
      final PagePosition b =
          PagePosition(pageIndex: 3, scrollFraction: 0.5);
      final PagePosition c =
          PagePosition(pageIndex: 3, scrollFraction: 0.25);
