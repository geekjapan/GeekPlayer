...
void main() {
  test('v1 -> v2 onUpgrade creates novel_* tables and preserves data',
      () async {
    ...
    raw.execute(
      ...
      <Object>['file:///a.mp4', 90000, DateTime.utc(2026, 5, 1).millisecondsSinceEpoch],
    );
    raw.execute(
      'INSERT INTO "recent_items" VALUES (?, ?, ?)',
      <Object>['file:///a.mp4', 'video', DateTime.utc(2026, 5, 1).millisecondsSinceEpoch],
    );
    ...
    expect(
      await db.novelBookmarksDao.getBookmark('narou', 'x'),
      isNull,
    );
