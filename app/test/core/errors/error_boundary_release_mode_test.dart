...
void main() {
  ...
  testWidgets('release-mode builder produces the localized restart fallback', (
    tester,
  ) async {
  ...
  testWidgets('debug-mode delegates to the previously installed builder', (
    tester,
  ) async {
    ...
    final widget = ErrorBoundary.buildErrorWidget(
      FlutterErrorDetails(exception: Exception('x'), stack: StackTrace.current),
    );
