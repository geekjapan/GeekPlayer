...
This change MUST NOT introduce any new ML-specific or native-bridge dependencies in `app/pubspec.yaml`; all code MUST compile with the existing dependency set.
