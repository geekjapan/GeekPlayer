# linux-platform-support Specification

## Purpose

Establishes the committed `app/linux/` CMake scaffolding and system-package prerequisites required to build GeekPlayer for Linux desktop via `flutter build linux`, including binary naming, GTK application identity, and GIT_SHA embedding.
