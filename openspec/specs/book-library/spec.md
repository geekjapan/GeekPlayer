...
Defines how the app catalogs locally opened books (PDF and EPUB), persisting their metadata and bookmarks, surfacing recent books on the home screen, and storing this data through a versioned drift schema that preserves existing playback, novel, consent, and settings data.
