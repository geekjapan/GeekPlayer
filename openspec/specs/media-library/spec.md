...
Indexes local video and audio files from user-nominated folders, persists watch/play history, favorites, and playlists via drift schema v6, and surfaces a media library section on the home screen.
