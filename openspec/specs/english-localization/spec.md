# english-localization Specification

## Purpose

Makes English a supported locale alongside Japanese (which remains the default/fallback), routes shared UI copy through `AppLocalizations`, and establishes the ARB-parity and localizable-by-default conventions that all later v0.2 UI changes must follow.
